...
const Footer = () => {
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[20px] gap-[8] grid
    grid-cols-5 m-auto items-center justify-center'>
      ...
      <div>
        ...
        <p className='text-white pb-[13px] opacity-70 leading-7 text-[15px]'>
      ...
      <div className='grid'>
        ...
        <div className='grid gap-3'>
          ...
          <li className='text-white opacity-[.7] hover:opacity-[1]'>Acoount</li>
